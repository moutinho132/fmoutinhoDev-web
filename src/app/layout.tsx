...
export default function RootLayout({
  ...
  return (
    <html lang="es">
      <head>
        {/* Meta Pixel Script */}
        {process.env.NEXT_PUBLIC_META_PIXEL_ID && process.env.NEXT_PUBLIC_META_PIXEL_ID !== 'your_pixel_id_here' && (
          <Script
            id="meta-pixel"
        ...
        {/* Google Analytics */}
        {process.env.NEXT_PUBLIC_GA_ID && process.env.NEXT_PUBLIC_GA_ID !== 'your_ga_measurement_id_here' && (
          <>
            <Script
